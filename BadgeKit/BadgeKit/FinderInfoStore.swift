...
public final class FinderInfoStore {
    ...
    public init(xattrStore: XattrStore) {
    ...
    public func restore(_ data: Data?, to path: String) {
        guard let data else {
    ...
    public func hasCustomIcon(at path: String) -> Bool {
    ...
    public func forceCustomIconState(at path: String) {
    ...
    public func clearCustomIconState(at path: String) {
