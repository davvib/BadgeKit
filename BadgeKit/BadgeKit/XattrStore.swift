...
public final class XattrStore {
    ...
    public func data(named name: String, at path: String) -> Data? {
        path.withCString { pathPointer in
    ...
    public func setData(_ data: Data, named name: String, at path: String) {
    ...
    public func remove(named name: String, at path: String) {
        path.withCString { pathPointer in
